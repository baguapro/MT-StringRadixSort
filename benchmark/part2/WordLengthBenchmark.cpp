...
static void RadixSortSeqPart2_wordsDictionary_BM(benchmark::State &state)
{
    ...
    randomString::instance().generate(state.range(0), 500'000u);
...
BENCHMARK(RadixSortSeqPart2_wordsDictionary_BM)->DenseRange(5u, 50u, 5u);
BENCHMARK(RadixSortMTPart2_wordsDictionary_BM)->DenseRange(5u, 50u, 5u);

BENCHMARK(StdStableSort_wordsDictionary_BM)->DenseRange(5u, 50u, 5u);
BENCHMARK(StdSort_wordsDictionary_BM)->DenseRange(5u, 50u, 5u);
